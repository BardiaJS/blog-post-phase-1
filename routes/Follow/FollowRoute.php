...
Route::get('/get-followers-list/user/{user}' , [FollowController::class , 'get_followers_list']);
Route::get('/get-following-list/user/{user}' , [FollowController::class , 'get_following_list']);
